...
function colscaler(red, green, blue)
{
    function col(x, DIST)
    {
        let r = red - (Math.tanh(DIST/17) * red);
        let g = green - (Math.tanh(DIST/17) * green);
        let b = blue - (Math.tanh(DIST/17) * blue);
...
lvl[0].cf = colscaler(0x67, 0xed, 0x3b);
lvl[1].cf = colscaler(0x3b, 0xed, 0x67);
lvl[2].cf = colscaler(0xc0, 0xed, 0x3b);